...
!==========================================================================
  ...
  // NB (madmatrix multi-precision): see helas.h. The fptype_polarization wavefunction
  // routines are only supported in scalar builds (cppnone or CUDA/HIP); SIMD is not
  // implemented. Fail loudly in SIMD builds.
#ifdef MGONGPU_CPPSIMD
#error The madmatrix multi-precision wavefunction routines (helas_fd.h) do not support SIMD builds: use BACKEND=cppnone or a CUDA/HIP build for the fptype_polarization/fptype_invmass precision experiment.
#endif
