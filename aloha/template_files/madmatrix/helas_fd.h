          ...
          const int ipar )        // input: particle# out of npar
  {
    ...
    if( fmass != 0. )
    {
      ...
      else
      {
        ...
        const fptype_polarization pp3 = fpmax<fptype_polarization>( fpternary<fptype_polarization_sv>( std::signbit( pvec3 ), ( pvec0 * pvec0 + pvec2 * pvec2 ) / ( pp - pvec3 ), pp + pvec3 ), 0. );
      ...
      const fptype_polarization_v pp3 = fpmax<fptype_polarization>( fpternary<fptype_polarization_sv>( std::signbit( pvec3 ), ( pvec0 * pvec0 + pvec2 * pvec2 ) / ( pp - pvec3 ), pp + pvec3 ), 0 );
    ...
    else
    {
      ...
      volatile fptype_polarization_sv p0p3 = fpmax<fptype_polarization>( fpternary<fptype_polarization_sv>( std::signbit( pvec0 ) == std::signbit( pvec3 ), pvec0 + pvec3, ( pvec1 * pvec1 + pvec2 * pvec2 ) / ( pvec0 - pvec3 ) ), 0 ); // volatile fixes #736
