...
class AdamOptimizer:
    ...
    def __init__(
        ...
        grad_clip_threshold: typing.SupportsFloat = 0.0,
    ) -> None: ...
...
class EventGenerator:
    ...
    def combine_to_lhe(
        self, file_name: str, lhe_completer: LHECompleter, meta: LHEMeta = ...
    ) -> None: ...
...
class MadnisConfig:
    ...
    @grad_clip_threshold.setter
    def grad_clip_threshold(self, arg0: typing.SupportsFloat) -> None: ...
    @property
