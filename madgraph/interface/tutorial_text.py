################################################################################
#
# Copyright (c) 2018 The MadGraph7 Development team and Contributors
#
...
write
MadGraph7>display particles
MadGraph7>display multiparticles

If you want to add a second process, use the add process command:
MadGraph7>add process p p > W+ j, W+ > l+ vl @2
...
MadGraph7>output MY_FIRST_MG5_RUN
"""
...
Please Enter:
MadGraph7> launch MY_FIRST_MG5_RUN
(you can interrupt the computation to continue the tutorial by pressing Ctrl-C)
"""

open_index = output

launch = """This step ends the tutorial of the basic commands of MadGraph7. You can
...
MadGraph7>history my_mg5_cmd.dat
"""
...
MadGraph7>import command my_mg5_cmd.dat
or from the shell:
./bin/madgraph my_mg5_cmd.dat

It is also possible to display this file directly from MadGraph7:
MadGraph7>open ./my_mg5_cmd.dat
"""
...
Any shell command can be launched by MadGraph7, by running \"shell\" or
...
MadGraph7>generate p p > go go; display diagrams
