...
// Created originally by: S. Roiser (Dec 2023, based on earlier work by A. Valassi) for the MadGraph7 CUDACPP plugin.
...
namespace madmatrix
{
  ...
  public:
    ...
    kernelAccessConst( const unsigned int* buffer )
    {
      ...
      static_assert( madmatrix::HostBufferChannelIds::isaligned() ); // ASSUME ALIGNED ARRAYS (reinterpret_cast will segfault otherwise!)
