...
#endif
{
  ...
  public:
    ...
    // Locate an event record (output) in a memory buffer (input) from the given event number (input)
    // [Signature (non-const) ===> fptype* ieventAccessRecord( fptype* buffer, const int ievt ) <===]
    static constexpr auto ieventAccessRecord = MemoryAccessHelper<MemoryAccessMomentaBase, fptype>::ieventAccessRecord;

    // Locate an event record (output) in a memory buffer (input) from the given event number (input)
    // [Signature (const) ===> const fptype* ieventAccessRecordConst( const fptype* buffer, const int ievt ) <===]
    static constexpr auto ieventAccessRecordConst = MemoryAccessHelper<MemoryAccessMomentaBase, fptype>::ieventAccessRecordConst;

    // Locate a field (output) of an event record (input) from the given field indexes (input)
    // [Signature (non-const) ===> fptype& decodeRecord( fptype* buffer, const int ipar, const int ipar ) <===]
    static constexpr auto decodeRecordIp4Ipar = MemoryAccessHelper<MemoryAccessMomentaBase, fptype>::decodeRecord;
    ...
    static constexpr auto decodeRecordIp4IparConst =
      MemoryAccessHelper<MemoryAccessMomentaBase, fptype>::template decodeRecordConst<int, int>;
    ...
    static constexpr auto ieventAccessIp4Ipar =
      MemoryAccessHelper<MemoryAccessMomentaBase, fptype>::template ieventAccessField<int, int>;
    ...
    static constexpr auto ieventAccessIp4IparConst =
      MemoryAccessHelper<MemoryAccessMomentaBase, fptype>::template ieventAccessFieldConst<int, int>;
    ...
    ieventAccessIp4IparConst( const fptype* buffer,
                                            ...
                                            const int ipar )
    {
      const fptype& out = MemoryAccessHelper<MemoryAccessMomentaBase, fptype>::template ieventAccessFieldConst<int, int>( buffer, ievt, ip4, ipar );
  ...
  public:
    ...
    kernelAccessIp4IparConst_s( const fptype* buffer,
                                ...
                                const int ipar )
    {
      const fptype& out = KernelAccessHelper<MemoryAccessMomentaBase, onDevice, fptype>::template kernelAccessFieldConst<int, int>( buffer, ip4, ipar );
