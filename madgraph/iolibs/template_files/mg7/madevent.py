...
class MadgraphProcess:
    ...
    def survey(self) -> None:
        ...
        if self.is_decay and phasespace_mode != "multichannel":
            ...
            # which a decay has no counterpart for. Decays have few channels, so
            # the multichannel phase space is the right one regardless.
            logger.info(
...
class MadgraphSubprocess:
    ...
    def build_integrands(
        ...
        cross_section = ms.DifferentialCrossSection(
            ...
            # For a decay this is the decaying particle's mass, and the flux
            # becomes 1/(2M): the result is a partial width in GeV, not a cross
            # section in pb.
