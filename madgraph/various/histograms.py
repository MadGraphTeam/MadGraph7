...
# bin/internal location of a process output (i.e. outside an MadGraph7 env.)
...
#            new_histo.select_central_weight(selected_label)           
        ...
        #                    "format of the HwU plot source is the MadGraph7"+
...
# ===========  END HELPER FUNCTIONS ===========
        ...
        if float(all_weights[2]['MERGING']) == merging_scale_chosen:
            ...
            if 'central value' not in sum(list(selected_weights.values()),[]):
                ...
                'MadGraph7 will chose the original central scale provided which '+\
...
################################################################################
#
# This gnuplot file was generated by MadGraph7 project, a program which 
# automatically generates Feynman diagrams and matrix elements for arbitrary
...
# Matplotlib histogram renderer generated by MadGraph7.
# Original command: %s
import os
import math
import subprocess
...
<header>
  <h1>%(title)s</h1>
  <p>Direct HTML/SVG histogram output generated by MadGraph7.</p>
