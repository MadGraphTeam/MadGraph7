...
#
# "./bin/madgraph cmd" exits 0 even when the "install <tool>" it contains
...
# through input/mg7_configuration.txt.
#
...
check_emela() {
    ...
    # path restore_heptools_emela writes into mg7_configuration.txt
