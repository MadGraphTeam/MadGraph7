...
C     CutTools call for loop # 1
      CALL ML5_0_LOOP_4(1,2,4,3,DCMPLX(MDL_MB),DCMPLX(MDL_MB)
     $ ,DCMPLX(MDL_MB),DCMPLX(MDL_MB),4,I_SO,1)
C     CutTools call for loop # 2
      CALL ML5_0_LOOP_4(1,2,3,4,DCMPLX(MDL_MB),DCMPLX(MDL_MB)
     $ ,DCMPLX(MDL_MB),DCMPLX(MDL_MB),4,I_SO,2)
C     CutTools call for loop # 3
      CALL ML5_0_LOOP_3(1,2,5,DCMPLX(MDL_MB),DCMPLX(MDL_MB)
...
C     CutTools call for loop # 6
      CALL ML5_0_LOOP_4(1,3,2,4,DCMPLX(MDL_MB),DCMPLX(MDL_MB)
...
C     CutTools call for loop # 11
      CALL ML5_0_LOOP_3(1,2,5,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
...
C     CutTools call for loop # 14
      CALL ML5_0_LOOP_4(1,3,2,4,DCMPLX(MDL_MT),DCMPLX(MDL_MT)
