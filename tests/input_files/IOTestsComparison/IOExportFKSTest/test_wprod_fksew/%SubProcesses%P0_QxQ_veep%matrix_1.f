...
C     Flavor table for the FLAV_IDX -> FLAVOR rebuild.
      ...
      DATA FLAV_TABLE / 1, 2, 1, 1, 1, 3, 4, 1, 1, 1 /
C     
C     FUNCTION
C     
      INTEGER SQSOINDEX1
...
C     Rebuild FLAVOR(NEXTERNAL) from the resolved flavor index.
      ...
      CALL FFV2MP0_3(W(2),W(1),FLV_189,DCMPLX(CMASS_MDL_MW),W(6))
      CALL FFV2P0_3(W(4),W(3),GC_124,DCMPLX(CMASS_MDL_MW),W(7))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(5),W(6),W(7),GC_4,AMP(1))
      CALL FFV1_2(W(4),W(5),GC_3,DCMPLX(ZERO),W(8))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(8),W(3),W(6),GC_124,AMP(2))
      CALL FFV1M_1(W(1),W(5),FLV_186,DCMPLX(ZERO),W(8))
C     Amplitude(s) for diagram number 3
      CALL FFV2M_0(W(2),W(8),W(7),FLV_189,AMP(3))
      CALL FFV1M_2(W(2),W(5),FLV_186,DCMPLX(ZERO),W(8))
C     Amplitude(s) for diagram number 4
      CALL FFV2M_0(W(8),W(1),W(7),FLV_189,AMP(4))
