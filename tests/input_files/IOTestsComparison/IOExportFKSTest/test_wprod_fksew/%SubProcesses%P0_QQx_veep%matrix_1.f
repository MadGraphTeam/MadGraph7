...
C     
C     
C     Process: _quark _anti_quark > _neutrino _anti_lepton a [ all =
...
C     Flavor table for the FLAV_IDX -> FLAVOR rebuild.
      ...
      DATA FLAV_TABLE / 2, 1, 1, 1, 1, 4, 3, 1, 1, 1 /
C     
C     FUNCTION
C     
      INTEGER SQSOINDEX1
...
C     Rebuild FLAVOR(NEXTERNAL) from the resolved flavor index.
      ...
      CALL FFV2MP0_3(W(1),W(2),FLV_189,DCMPLX(CMASS_MDL_MW),W(6))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1M_2(W(1),W(5),FLV_186,DCMPLX(ZERO),W(8))
C     Amplitude(s) for diagram number 3
      CALL FFV2M_0(W(8),W(2),W(7),FLV_189,AMP(3))
      CALL FFV1M_1(W(2),W(5),FLV_186,DCMPLX(ZERO),W(8))
C     Amplitude(s) for diagram number 4
      CALL FFV2M_0(W(1),W(8),W(7),FLV_189,AMP(4))
