...
C     Flavor table for the FLAV_IDX -> FLAVOR rebuild.
      INTEGER NMASK_FLAV
      PARAMETER (NMASK_FLAV=6)
      INTEGER MASK_J
      INTEGER FLAV_TABLE(NEXTERNAL, NMASK_FLAV)
      DATA FLAV_TABLE / 1, 2, 1, 1, 1, 2, 2, 2, 1, 2, 3, 3, 3, 4, 1, 1
     $ , 3, 4, 2, 2, 3, 4, 3, 3 /
C     
C     GLOBAL VARIABLES
C     
...
CF2PY INTENT(OUT) :: GET_FLAVOR_INDEX
      ...
      DATA FI_TABLE /1, 2, 1, 1, 1, 2, 2, 2, 1, 2, 3, 3, 3, 4, 1, 1, 3
     $ , 4, 2, 2, 3, 4, 3, 3/
...
CF2PY INTENT(OUT) :: FLAVOR(NEXTERNAL)
      ...
      DATA FA_TABLE /1, 2, 1, 1, 1, 2, 2, 2, 1, 2, 3, 3, 3, 4, 1, 1, 3
     $ , 4, 2, 2, 3, 4, 3, 3/
      FA_USE = FLAV_IDX
