...
C     
C     
C     Process: a _anti_quark > _neutrino _anti_lepton _anti_quark [
C      all = QCD QED ] QCD^2<=0 QED^2<=6
C     
C     
C     CONSTANTS
C     
...
C     
      ...
      INTEGER IDEN_FLAVOR(2)
      DATA IDEN_FLAVOR / 12, 12 /
C     ----------
C     BEGIN CODE
C     ----------
      FLAV_IDX=REAL_FLAVOR_INDEX_D(NFKSPROCESS)
      HEL_INDEX=NFKSPROCESS
      IF (FLAV_IDX.GE.1.AND.FLAV_IDX.LE.2) IDEN=IDEN_FLAVOR(FLAV_IDX)
...
C     Flavor table for the FLAV_IDX -> FLAVOR rebuild.
      ...
      DATA FLAV_TABLE / 1, 1, 1, 1, 2, 1, 3, 1, 1, 4 /
C     
C     FUNCTION
C     
      INTEGER SQSOINDEX2
...
C     Rebuild FLAVOR(NEXTERNAL) from the resolved flavor index.
      ...
      CALL FFV1M_1(W(2),W(1),FLV_186,DCMPLX(ZERO),W(6))
      CALL FFV2P0_3(W(4),W(3),GC_124,DCMPLX(CMASS_MDL_MW),W(7))
C     Amplitude(s) for diagram number 1
      CALL FFV2M_0(W(5),W(6),W(7),FLV_189,AMP(1))
      CALL FFV1_2(W(4),W(1),GC_3,DCMPLX(ZERO),W(6))
      CALL FFV2MP0_3(W(5),W(2),FLV_189,DCMPLX(CMASS_MDL_MW),W(4))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(6),W(3),W(4),GC_124,AMP(2))
      CALL FFV1M_2(W(5),W(1),FLV_186,DCMPLX(ZERO),W(6))
C     Amplitude(s) for diagram number 3
      CALL FFV2M_0(W(6),W(2),W(7),FLV_189,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1),W(4),W(7),GC_4,AMP(4))
