...
C     
C     
C     Process: _quark a > _neutrino _anti_lepton _quark [ all = QCD
...
C     Flavor table for the FLAV_IDX -> FLAVOR rebuild.
      ...
      DATA FLAV_TABLE / 2, 1, 1, 1, 1, 4, 1, 1, 1, 3 /
C     
C     FUNCTION
C     
      INTEGER SQSOINDEX3
...
C     Rebuild FLAVOR(NEXTERNAL) from the resolved flavor index.
      ...
      CALL FFV1M_2(W(1),W(2),FLV_186,DCMPLX(ZERO),W(6))
      CALL FFV2P0_3(W(4),W(3),GC_124,DCMPLX(CMASS_MDL_MW),W(7))
C     Amplitude(s) for diagram number 1
      CALL FFV2M_0(W(6),W(5),W(7),FLV_189,AMP(1))
      CALL FFV2MP0_3(W(1),W(5),FLV_189,DCMPLX(CMASS_MDL_MW),W(6))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1M_1(W(5),W(2),FLV_186,DCMPLX(ZERO),W(6))
C     Amplitude(s) for diagram number 4
      CALL FFV2M_0(W(1),W(6),W(7),FLV_189,AMP(4))
