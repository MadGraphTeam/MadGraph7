      SUBROUTINE SB_SF_004(P,ANS_SUMMED,RET_AMP_SPLIT_CNT,LOC_SAVEAMP)
C     
...
C     BEGIN CODE
C     
      CALL SB_SF_004_SPLITORDERS(P,ANS,LOC_SAVEAMP)
...
C     this is to avoid fake non-zero contributions 
      ...
      SUBROUTINE SB_SF_NOCHECK_004(P,ANS_SUMMED,RET_AMP_SPLIT_CNT
     $ ,LOC_SAVEAMP)
C     
C     Generated by MadGraph7 v. %(version)s, %(date)s
C     By the MadGraph7 Development Team
...
C     BEGIN CODE
C     
      CALL SB_SF_NOCHECK_004_SPLITORDERS(P,ANS,LOC_SAVEAMP)
C     color-linked borns are called for QCD-type emissions
      ANS_SUMMED = 0D0
      MAX_VAL = 0D0
...
C     this is to avoid fake non-zero contributions 
      ...
      SUBROUTINE SB_SF_004_SPLITORDERS(P1,ANS,LOC_SAVEAMP)
C     
C     Generated by MadGraph7 v. %(version)s, %(date)s
C     By the MadGraph7 Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
     ...
     $   //' called only with calculatedborn = true'
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL,NFKSPROCESS)) THEN
          CALL B_SF_004(IHEL,T,LOC_SAVEAMP)
          DO I=1,NSQAMPSO
            ANS(I)=ANS(I)+T(I)
          ENDDO
        ENDIF
      ...
      SUBROUTINE SB_SF_NOCHECK_004_SPLITORDERS(P1,ANS,LOC_SAVEAMP)
C     
C     Generated by MadGraph7 v. %(version)s, %(date)s
C     By the MadGraph7 Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL,NFKSPROCESS)) THEN
          CALL B_SF_NOCHECK_004(IHEL,T,LOC_SAVEAMP)
          DO I=1,NSQAMPSO
            ANS(I)=ANS(I)+T(I)
          ENDDO
        ENDIF
      ...
      SUBROUTINE B_SF_004(HELL,ANS,LOC_SAVEAMP)
C     
C     Generated by MadGraph7 v. %(version)s, %(date)s
C     By the MadGraph7 Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     JAMPs contributing to orders QCD=0 QED=2
     ...
     $       *DCONJG(JAMP1(I,N))
      ...
      SUBROUTINE B_SF_NOCHECK_004(HELL,ANS,LOC_SAVEAMP)
C     
C     Generated by MadGraph7 v. %(version)s, %(date)s
C     By the MadGraph7 Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
