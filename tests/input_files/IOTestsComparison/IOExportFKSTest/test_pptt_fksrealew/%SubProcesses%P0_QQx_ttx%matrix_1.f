...
C     
C     
C     Process: _quark _anti_quark > t t~ a [ real = QCD QED ] QCD^2<=4
C      QED^2<=2
C     
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1M_2(W(1),W(5),FLV_94,ZERO,ZERO,W(7))
      CALL FFV1P0_3(W(4),W(3),GC_11,ZERO,ZERO,W(6))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(7),W(2),W(6),GC_11,AMP(3))
      CALL FFV1M_1(W(2),W(5),FLV_94,ZERO,ZERO,W(7))
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1_2(W(4),W(5),GC_2,MDL_MT,MDL_WT,W(7))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(7),W(3),W(6),GC_11_VEC(IVEC),AMP(2))
      CALL FFV1M_2(W(1),W(5),FLV_94,ZERO,ZERO,W(7))
      CALL FFV1P0_3(W(4),W(3),GC_11_VEC(IVEC),ZERO,ZERO,W(6))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(7),W(2),W(6),GC_11_VEC(IVEC),AMP(3))
      CALL FFV1M_1(W(2),W(5),FLV_94,ZERO,ZERO,W(7))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1),W(7),W(6),GC_11_VEC(IVEC),AMP(4))
C     JAMPs contributing to orders QCD=2 QED=1
      TMP_JAMP(2) = AMP(3) +  AMP(4)  ! used 2 times
      TMP_JAMP(1) = AMP(1) +  AMP(2)  ! used 2 times
      TMP_JAMP(3) = TMP_JAMP(2) +  TMP_JAMP(1)  ! used 2 times
