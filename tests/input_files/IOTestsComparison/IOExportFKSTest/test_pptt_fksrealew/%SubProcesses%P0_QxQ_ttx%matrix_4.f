...
C     
C     
C     Process: g _quark > t t~ _quark [ real = QCD QED ] QCD^2<=4
C      QED^2<=2
C     
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1MP0_3(W(2),W(5),FLV_94,ZERO,ZERO,W(10))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV6_2M_3(W(2),W(5),FLV_96,FLV_97,MDL_MZ,MDL_WZ,W(12))
...
C     Amplitude(s) for diagram number 10
      CALL FFV1M_0(W(2),W(6),W(7),FLV_94,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(2),W(6),W(8),GC_11,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV6_2M_0(W(2),W(6),W(9),FLV_96,FLV_97,AMP(12))
...
C     Rebuild FLAVOR(NEXTERNAL) from the resolved flavor index.
      ...
      CALL IXXXXX(P(0,4),MDL_MT,NHEL(4),-1, FLAVOR(4),W(4))
      CALL OXXXXX(P(0,5),ZERO,NHEL(5),+1, FLAVOR(5),W(5))
      CALL FFV1_2(W(2),W(1),GC_11_VEC(IVEC),ZERO,ZERO,W(6))
      CALL FFV1P0_3(W(4),W(3),GC_2,ZERO,ZERO,W(7))
C     Amplitude(s) for diagram number 1
      CALL FFV1M_0(W(6),W(5),W(7),FLV_94,AMP(1))
...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(4),W(6),W(10),GC_2,AMP(4))
      CALL FFV1P0_3(W(2),W(5),GC_11_VEC(IVEC),ZERO,ZERO,W(11))
C     Amplitude(s) for diagram number 5
...
C     Amplitude(s) for diagram number 9
      CALL FFV6_2_0(W(6),W(3),W(12),GC_FFV_4,GC_FFV_5,AMP(9))
      CALL FFV1_1(W(5),W(1),GC_11_VEC(IVEC),ZERO,ZERO,W(6))
C     Amplitude(s) for diagram number 10
      CALL FFV1M_0(W(2),W(6),W(7),FLV_94,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(2),W(6),W(8),GC_11_VEC(IVEC),AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV6_2M_0(W(2),W(6),W(9),FLV_96,FLV_97,AMP(12))
C     Amplitude(s) for diagram number 13
