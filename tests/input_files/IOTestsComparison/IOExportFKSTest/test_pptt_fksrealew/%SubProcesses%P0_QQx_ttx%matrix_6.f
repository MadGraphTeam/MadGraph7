...
C     
C     
C     Process: _quark g > t t~ _quark [ real = QCD QED ] QCD^2<=4
C      QED^2<=2
C     
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      CALL FFV1M_0(W(6),W(5),W(7),FLV_94,AMP(1))
...
C     Amplitude(s) for diagram number 3
      CALL FFV6_2M_0(W(6),W(5),W(9),FLV_96,FLV_97,AMP(3))
      CALL FFV1MP0_3(W(1),W(5),FLV_94,ZERO,ZERO,W(6))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV6_2M_3(W(1),W(5),FLV_96,FLV_97,MDL_MZ,MDL_WZ,W(12))
...
C     Amplitude(s) for diagram number 11
      CALL FFV1M_0(W(1),W(11),W(7),FLV_94,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1),W(11),W(8),GC_11,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV6_2M_0(W(1),W(11),W(9),FLV_96,FLV_97,AMP(13))
...
C     Rebuild FLAVOR(NEXTERNAL) from the resolved flavor index.
      ...
      CALL IXXXXX(P(0,4),MDL_MT,NHEL(4),-1, FLAVOR(4),W(4))
      CALL OXXXXX(P(0,5),ZERO,NHEL(5),+1, FLAVOR(5),W(5))
      CALL FFV1_2(W(1),W(2),GC_11_VEC(IVEC),ZERO,ZERO,W(6))
      CALL FFV1P0_3(W(4),W(3),GC_2,ZERO,ZERO,W(7))
C     Amplitude(s) for diagram number 1
      CALL FFV1M_0(W(6),W(5),W(7),FLV_94,AMP(1))
      CALL FFV1P0_3(W(4),W(3),GC_11_VEC(IVEC),ZERO,ZERO,W(8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(6),W(5),W(8),GC_11_VEC(IVEC),AMP(2))
      CALL FFV6_2_3(W(4),W(3),GC_FFV_4,GC_FFV_5,MDL_MZ,MDL_WZ,W(9))
C     Amplitude(s) for diagram number 3
      CALL FFV6_2M_0(W(6),W(5),W(9),FLV_96,FLV_97,AMP(3))
      CALL FFV1MP0_3(W(1),W(5),FLV_94,ZERO,ZERO,W(6))
...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(4),W(10),W(6),GC_2,AMP(4))
      CALL FFV1P0_3(W(1),W(5),GC_11_VEC(IVEC),ZERO,ZERO,W(11))
C     Amplitude(s) for diagram number 5
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_1(W(5),W(2),GC_11_VEC(IVEC),ZERO,ZERO,W(11))
C     Amplitude(s) for diagram number 11
      CALL FFV1M_0(W(1),W(11),W(7),FLV_94,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1),W(11),W(8),GC_11_VEC(IVEC),AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV6_2M_0(W(1),W(11),W(9),FLV_96,FLV_97,AMP(13))
C     JAMPs contributing to orders QCD=3 QED=0
      JAMP(1,1) = (-5.000000000000000D-01)*AMP(2)+(-5.000000000000000D
