...
C     integers over DENOM)
      ...
      COMMON /C_BORN_COLOR_MATRICES/ CF, DENOM
      DATA DENOM(0)/1/
      DATA (CF(I,0),I=1,3) /9,6,9/
      DATA DENOM(1)/1/
      DATA (CF(I,1),I=1,3) /-12,-8,0/
      DATA DENOM(2)/1/
      DATA (CF(I,2),I=1,3) /0,8,0/
      DATA DENOM(3)/1/
      DATA (CF(I,3),I=1,3) /0,-8,-12/
      DATA DENOM(4)/1/
      DATA (CF(I,4),I=1,3) /0,-8,-12/
      DATA DENOM(5)/1/
      DATA (CF(I,5),I=1,3) /0,8,0/
      DATA DENOM(6)/1/
      DATA (CF(I,6),I=1,3) /6,4,6/
      DATA DENOM(7)/1/
      DATA (CF(I,7),I=1,3) /-12,-8,0/
      DATA DENOM(8)/1/
      DATA (CF(I,8),I=1,3) /6,4,6/
      END
