...
C     ----------
      ...
      IF (FLAV_IDX.GE.1.AND.FLAV_IDX.LE.1) IDEN=IDEN_FLAVOR(FLAV_IDX)
...
C     Rebuild FLAVOR(NEXTERNAL) from the resolved flavor index.
      ...
      CALL VXXXXX(P(0,5),ZERO,NHEL(5),+1,W(5))
      CALL FFV1_1(W(3),W(1),GC_2,MDL_MT,MDL_WT,W(6))
      CALL FFV1_2(W(4),W(2),GC_11_VEC(IVEC),MDL_MT,MDL_WT,W(7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(7),W(6),W(5),GC_11_VEC(IVEC),AMP(1))
      CALL VVV1P0_1(W(2),W(5),GC_10_VEC(IVEC),ZERO,ZERO,W(8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(4),W(6),W(8),GC_11_VEC(IVEC),AMP(2))
      CALL FFV1_2(W(4),W(5),GC_11_VEC(IVEC),MDL_MT,MDL_WT,W(9))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(9),W(6),W(2),GC_11_VEC(IVEC),AMP(3))
      CALL FFV1_2(W(4),W(1),GC_2,MDL_MT,MDL_WT,W(6))
      CALL FFV1_1(W(3),W(2),GC_11_VEC(IVEC),MDL_MT,MDL_WT,W(4))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(6),W(4),W(5),GC_11_VEC(IVEC),AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(6),W(3),W(8),GC_11_VEC(IVEC),AMP(5))
      CALL FFV1_1(W(3),W(5),GC_11_VEC(IVEC),MDL_MT,MDL_WT,W(8))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(6),W(8),W(2),GC_11_VEC(IVEC),AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(9),W(4),W(1),GC_2,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(7),W(8),W(1),GC_2,AMP(8))
