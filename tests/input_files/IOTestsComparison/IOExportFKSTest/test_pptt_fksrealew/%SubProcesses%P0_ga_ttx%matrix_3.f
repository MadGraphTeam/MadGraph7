...
C     
C     
C     Process: _quark a > t t~ _quark [ real = QCD QED ] QCD^2<=4
C      QED^2<=2
C     
C     
C     CONSTANTS
...
C     Rebuild FLAVOR(NEXTERNAL) from the resolved flavor index.
      ...
      CALL FFV1M_2(W(1),W(2),FLV_94,ZERO,ZERO,W(6))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1M_1(W(5),W(2),FLV_94,ZERO,ZERO,W(8))
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1),W(5),GC_11_VEC(IVEC),ZERO,ZERO,W(6))
      CALL FFV1_1(W(3),W(2),GC_2,MDL_MT,MDL_WT,W(8))
C     Amplitude(s) for diagram number 2
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1M_1(W(5),W(2),FLV_94,ZERO,ZERO,W(8))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1),W(8),W(7),GC_11_VEC(IVEC),AMP(4))
C     JAMPs contributing to orders QCD=2 QED=1
      TMP_JAMP(2) = AMP(3) +  AMP(4)  ! used 2 times
      TMP_JAMP(1) = AMP(1) +  AMP(2)  ! used 2 times
      TMP_JAMP(3) = TMP_JAMP(2) +  TMP_JAMP(1)  ! used 2 times
