...
C     
C     
C     Process: _anti_quark _quark > t t~ g [ real = QCD QED ] QCD^2<=4
C      QED^2<=2
C     
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1MP0_3(W(2),W(1),FLV_94,ZERO,ZERO,W(8))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV6_2M_3(W(2),W(1),FLV_96,FLV_97,MDL_MZ,MDL_WZ,W(10))
...
C     Rebuild FLAVOR(NEXTERNAL) from the resolved flavor index.
      ...
      CALL IXXXXX(P(0,4),MDL_MT,NHEL(4),-1, FLAVOR(4),W(4))
      CALL VXXXXX(P(0,5),ZERO,NHEL(5),+1,W(5))
      CALL FFV1P0_3(W(2),W(1),GC_11_VEC(IVEC),ZERO,ZERO,W(6))
...
C     Amplitude(s) for diagram number 7
      CALL FFV6_2_0(W(9),W(3),W(10),GC_FFV_4,GC_FFV_5,AMP(7))
      CALL FFV1_1(W(1),W(5),GC_11_VEC(IVEC),ZERO,ZERO,W(9))
      CALL FFV1P0_3(W(4),W(3),GC_2,ZERO,ZERO,W(10))
C     Amplitude(s) for diagram number 8
      CALL FFV1M_0(W(2),W(9),W(10),FLV_94,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(2),W(9),W(7),GC_11_VEC(IVEC),AMP(9))
      CALL FFV6_2_3(W(4),W(3),GC_FFV_4,GC_FFV_5,MDL_MZ,MDL_WZ,W(6))
C     Amplitude(s) for diagram number 10
      CALL FFV6_2M_0(W(2),W(9),W(6),FLV_96,FLV_97,AMP(10))
      CALL FFV1_2(W(2),W(5),GC_11_VEC(IVEC),ZERO,ZERO,W(9))
C     Amplitude(s) for diagram number 11
      CALL FFV1M_0(W(9),W(1),W(10),FLV_94,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(9),W(1),W(7),GC_11_VEC(IVEC),AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV6_2M_0(W(9),W(1),W(6),FLV_96,FLV_97,AMP(13))
C     JAMPs contributing to orders QCD=3 QED=0
      JAMP(1,1) = (-1.666666666666667D-01)*AMP(3)+(-1.666666666666667D
