...
C     Helas calls and color basis for the Sudakov amplitude
      CALL IXXXXX(P(0,1),ZERO,NHEL(1),+1, FLAVOR(1),W(1))
      CALL OXXXXX(P(0,2),MDL_MT,NHEL(2),-1, FLAVOR(2),W(2))
      CALL VXXXXX(P(0,3),MDL_MW,NHEL(3),+1,W(3))
      CALL VXXXXX(P(0,4),MDL_MZ,NHEL(4),+1,W(4))
      CALL FFV2P0_3(W(1),W(2),GC_124,MDL_MW,MDL_WW,W(5))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(3),W(5),W(4),GC_71,AMP2(1))
      CALL FFS1_3(W(1),W(2),GC_39,MDL_MW,MDL_WW,W(5))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(3),W(4),W(5),GC_85,AMP2(2))
      CALL FFV2_2(W(1),W(3),GC_124,MDL_MT,MDL_WT,W(5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(5),W(2),W(4),GC_69,GC_76,AMP2(3))
      CALL FFV2_3_2(W(1),W(4),GC_68,GC_76,ZERO,ZERO,W(5))
