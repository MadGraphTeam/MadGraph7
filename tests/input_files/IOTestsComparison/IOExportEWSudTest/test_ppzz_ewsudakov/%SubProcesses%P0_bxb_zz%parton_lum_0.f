...
C     
      ...
      DOUBLE PRECISION BX1_COMPONENTS(N_EE)
      DOUBLE PRECISION B2_COMPONENTS(N_EE)
...
C         
      ...
      IF (ABS(LPP(1)) .GE. 1) THEN
        BX1=PDG2PDF(LPP(1),-5,1,XBK(1),DSQRT(Q2FACT(1)))
        IF ((ABS(LPP(1)).EQ.4.OR.ABS(LPP(1)).EQ.3)
     $   .AND.PDLABEL.NE.'none') BX1_COMPONENTS(1:N_EE) =
     ...
     $ =EE_COMP_PROD(BX1_COMPONENTS,B2_COMPONENTS)
      DO I=1,IPROC
